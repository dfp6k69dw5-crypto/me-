...
# Repository-held pause flag: already-running pulse jobs may continue dispatching,
# but new society turns resolve to rest while maintenance/reset is happening.
