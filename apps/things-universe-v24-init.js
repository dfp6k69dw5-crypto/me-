function pointerUp(e){let was=gesture;pointers.delete(e.pointerId);
  if(was?.type==='select'&&!was.moved&&was.node){toggleConnectNode(was.node)}
  if(was?.type==='node'&&dragNode){dragNode.pinned=false;dragNode=null;dragSample=null;kick(1);toast('Released — neighborhood resettling')}
...
updateHeight();ui('Ready');updateConnectUI();draw();
