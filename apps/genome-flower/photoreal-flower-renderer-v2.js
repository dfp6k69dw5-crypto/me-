...
// Four sequence-derived architecture loci choose the coarse floral body plan.
// Mutations outside these loci preserve family while still changing growth,
// pigment, texture and organ proportions; mutations in the loci can switch family.
export function classifyFlower(genome){
  const TYPES=['rose','lily','tulip','daisy','sunflower','orchid','iris','bell'];
  const code=mix(genome.geneHash[3],genome.geneHash[11],genome.geneHash[19],genome.geneHash[27],0xf10a2026);
