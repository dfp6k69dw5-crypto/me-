...
$('#auto').onclick=toggle;$('#connect').onclick=toggleConnectMode;$('#bridge').onclick=findBridge;$('#fit').onclick=fit;
$('#reset').onclick=()=>{cancelClusterPending();reset();connectMode=false;connectSelection=[];updateConnectUI()};
$('#rx').onclick=()=>$('#reader').classList.remove('open');$('#selExplain').onclick=explainSelected;$('#selClear').onclick=clearConnectSelection;
